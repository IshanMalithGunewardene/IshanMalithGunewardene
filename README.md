...
| Frontend              | HTML5, CSS3, Sass, Bootstrap, Tailwind CSS, React                                             |
| Backend               | Node.js, Express.js, Spring Boot                                                              |
| Databases             | MongoDB, MySQL                                                                                |
| Mobile / Cross‑platform | React Native                                                                                |
| Design & UI           | Figma, Adobe Illustrator, Adobe Photoshop                                                     |
| IDEs & Editors        | IntelliJ IDEA Ultimate, Visual Studio Code, Neovim                                            |
| AI Tools              | GitHub Copilot, Antigravit                                                                    |
| Tools & Workflow      | Git                                                                                           |
